L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
       ...
       $(sliderContainer).append('<div id="slider-min"></div><div id="leaflet-slider" style="width:200px; inline-block; margin: 0 5px 0 5px;"></div><div id="slider-max"></div><div id="slider-timestamp"</div>');
